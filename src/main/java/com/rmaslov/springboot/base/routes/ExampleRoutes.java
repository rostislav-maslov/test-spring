package com.rmaslov.springboot.base.routes;

public class ExampleRoutes {
    public static final String GET = BaseApiRoutes.V1 + "/get";
    public static final String GET_PARAM = BaseApiRoutes.V1 + "/get-with-param";
    public static final String GET_PATH = BaseApiRoutes.V1 + "/get-with-path-{pathVariable}";
